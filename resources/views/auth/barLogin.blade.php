...
<!-- BEGIN HEAD -->
    <head>
        <meta charset="utf-8"/>
        <title>Bar Lantai 2 Login</title>
...
<!--            <img src="assets/img/logo.png" alt=""/>-->
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="{{ url('/auth/barLogin') }}" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <h3 class="form-title" style='font-size: 38px;'>Bar Lantai 2 Login</h3>        
                <ul>
