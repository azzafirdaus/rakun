...
<!-- BEGIN HEAD -->
    <head>
        <meta charset="utf-8"/>
        <title>Bar Lantai 4 Login</title>
...
<!--            <img src="assets/img/logo.png" alt=""/>-->
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="{{ url('/auth/bar3Login') }}" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <h3 class="form-title" style='font-size: 38px;'>Bar Lantai 4 Login</h3>        
                <ul>
