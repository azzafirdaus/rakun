...
<!-- BEGIN HEAD -->
    ...
    <body class="terapis">
        ...
        <div class="home-button">
            <form class="terapis-form" action="{{ url('menuTerapis') }}" method="post"> 
                ...
                <div>
                    <button type="submit">NAIK</button>
                </div>

                <div>
                    <button type="button" onclick="location.href = '{{ url('menuTerapisStop') }}';">STOP</button>
                </div>
            </form>
        </div>
