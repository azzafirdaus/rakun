...
<!-- BEGIN HEAD -->
    ...
    <body class="terapis">
        ...
        <!-- END LOGO -->
        <p style='font-size: 60px; color: white; text-align: center;'>PEMBAYARAN</p>
        <p style='font-size: 60px; color: white; text-align: center;'>KARTU PELANGGAN</p>
        <br>
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->

            <form class="terapis-form" action="{{ url('bayarTerapis') }}" method="post">
                ...
                <br>    
                    ...
                    <p id="success-notif" style='font-size: 16px; color: green; display: none;'>{{ $success }}</p>
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input id="pelanggan-barcode" class="form-control placeholder-no-fix" type="text" style='font-size: 24px;' autocomplete="off" placeholder="Scan No. Kartu" name="noKartu" autofocus/>
                    </div>
                </div>
                <br>
    ...
    window.onload = function() {
        ...
        var notif =  document.getElementById("success-notif").innerHTML;
        if (notif == 'gagal') {
            setTimeout(function(){ location.href = "{{ url('menuTerapis') }} "; }, 3000); 
        }
    }
