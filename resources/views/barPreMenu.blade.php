...
<!--            <img src="assets/img/logo.png" alt=""/>-->
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="{{ url('barPreMenu') }}" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <h3 class="form-title" style='font-size: 38px;'>Menu Bar Lantai 2</h3>

				<p style='font-size: 16px; color: green'>{{ $success }}</p>
                <div class="form-actions" >
                    <button type="button" onclick="location.href = '{{ url('cariBarPre') }}';" class="btn btn-default pull-left" id="cari">
                ...
                <div class="form-actions">
                    <button type="button" onclick="location.href = '{{ url('auth/barLogout') }}';" class="btn btn-primary">
