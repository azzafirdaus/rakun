...
<!-- BEGIN HEAD -->
    <head>
        <meta charset="utf-8"/>
        <title>Restoran 2 Auto Menu</title>
    ...
    <body class="terapis">
        ...
        <form class="terapis-form" action="{{ url('restoran2/makanan') }}" method="get"> 
            ...
            <button type="submit" formaction="{{ url('restoran2/ob') }}" class="btn btn-primary" style="margin-right: 30px; padding: 10px 40px; font-size: 28px; float: right;">
                OB
            </button>
        </form>
...
<script type="text/javascript">
    window.onload = function() {
        setTimeout(function(){ location.href = "{{ url('restoran2') }} "; }, 8000);
    };
</script>
</html>