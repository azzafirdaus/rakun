...
<!-- BEGIN HEAD -->
    ...
    <body class="login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="{{ url('restoran2') }}" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <h3 class="form-title hidden-print" style='font-size: 38px;'>Invoice Restoran2</h3>
                <br>
                ...
                <div class="form-actions hidden-print">
                    ...
                    <div class="pull-right">
                        <button type="submit" formaction="{{ url('restoran2') }}" class="btn btn-success" onclick="window.print();">
