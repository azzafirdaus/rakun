...
<!--            <img src="assets/img/logo.png" alt=""/>-->
        ...
        <div class="content">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="post">
                                        ...
                                        <button type="submit" formaction="{{ url('restoran/minuman/delete') }}" class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button>
                                    </form>
                                </td>
                            </tr>    
                            @endforeach     
            ...
            <br>
            <form action="{{ url('restoran') }}" method="post" id="formnya">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="form-actions hidden-print">
                    ...
                    <div class="pull-right">
                        <button type="submit" formaction="{{ url('restoran/minuman/order') }}" class="btn btn-success">
