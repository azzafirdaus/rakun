                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="post">
                                        ...
                                        <button type="submit" formaction="{{ url('restoran/rokok/delete') }}" class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button>
                                    </form>
                                </td>
                            </tr>    
                            @endforeach     
            ...
            <form action="{{ url('restoran') }}" method="post" id="formnya">
                ...
                <div class="form-actions hidden-print">
                    ...
                    <div class="pull-right">
                        <button type="submit" formaction="{{ url('restoran/rokok/order') }}" class="btn btn-success">
