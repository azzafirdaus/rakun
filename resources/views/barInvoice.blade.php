...
<!-- BEGIN HEAD -->
    <head>
        <meta charset="utf-8"/>
        <title>Invoice Bar Lantai 2</title>
...
<!--            <img src="assets/img/logo.png" alt=""/>-->
        ...
        <div class="content">
            ...
            <form class="login-form" action="{{ url('backToBar') }}" method="post">
                ...
                <h3 class="form-title hidden-print" style='font-size: 38px;'>Invoice Bar Lantai 2</h3>
                ...
                <div class="form-actions hidden-print">
                    ...
                    <div class="pull-right">
                        <button type="submit" formaction="{{ url('barPrint') }}" class="btn btn-success" onclick="window.print();">
