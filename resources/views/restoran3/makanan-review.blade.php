                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="post">
                                        ...
                                        <button type="submit" formaction="{{ url('restoran3/makanan/delete') }}" class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button>
                                    </form>
                                </td>
                            </tr>    
                            @endforeach     
            ...
            <form action="{{ url('restoran3') }}" method="post" id="formnya">
                ...
                <div class="form-actions hidden-print">
                    ...
                    <div class="pull-right">
                        <button type="submit" formaction="{{ url('restoran3/makanan/order') }}" class="btn btn-success">
